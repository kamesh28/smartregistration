...
public class HomeController {
	...
	public String signup(Model model)
	{
		...
		model.addAttribute("title", "Register- National Academic Depository");
		model.addAttribute("user", new User());          //mapping in singnup form
		return "signup";
	}
	...
	{
		model.addAttribute("titele", "Login Page");
		return "login";
	}
